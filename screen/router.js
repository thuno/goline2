...
if (UserService.token()) {
    if (url.includes('home') || url.every(e => !e.match(/file\?id\=[\d]*/g))) {
        ...
        cssTag.href = "https://cdn.jsdelivr.net/gh/thuno/goline2@28682a3/screen/module/home/home.css"
        // cssTag.href = "./screen/module/home/home.css"
        document.head.appendChild(cssTag)
        $('body').load('https://cdn.jsdelivr.net/gh/thuno/goline2@28682a3/screen/module/home/home.html')
    ...
    let cssTag = document.createElement('link')
    cssTag.rel = "stylesheet"
    cssTag.href = "https://cdn.jsdelivr.net/gh/thuno/goline2@28682a3/screen/module/login/login-view.css"
    document.head.appendChild(cssTag)
    $('body').load('https://cdn.jsdelivr.net/gh/thuno/goline2@28682a3/screen/module/login/login-view.html')
}