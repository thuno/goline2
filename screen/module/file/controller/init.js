...
$('body > #body').load('https://cdn.jsdelivr.net/gh/thuno/goline2@76ab021/project-component/loading.html', async function () {
    ...
    if (pInforRes.Code === 200) {
        ...
        $('body > #body').load('https://cdn.jsdelivr.net/gh/thuno/goline2@76ab021/screen/module/file/local-component/body-layout.html', async function () {
            permissionTool()
            customerList()
