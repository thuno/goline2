...
$('body > #body').load('https://cdn.jsdelivr.net/gh/thuno/goline2@ead813a/project-component/loading.html', async function () {
    ...
    $('body > #body').load('https://cdn.jsdelivr.net/gh/thuno/goline2@ead813a/screen/module/file/local-component/body-layout.html', async function () {
        permissionTool()
        customerList()
