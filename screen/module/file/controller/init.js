...
$('body > #body').load('https://cdn.jsdelivr.net/gh/thuno/goline2@4e0062d/project-component/loading.html', async function () {
    ...
    if (pInforRes.Code === 200) {
        ...
        $('body > #body').load('https://cdn.jsdelivr.net/gh/thuno/goline2@4e0062d/screen/module/file/local-component/body-layout.html', async function () {
            permissionTool()
            customerList()
