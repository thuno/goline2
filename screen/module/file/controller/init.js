...
$('body > #body').load('https://cdn.jsdelivr.net/gh/thuno/goline2@650710e/project-component/loading.html', async function () {
    ...
    $('body > #body').load('https://cdn.jsdelivr.net/gh/thuno/goline2@650710e/screen/module/file/local-component/body-layout.html', async function () {
        permissionTool()
        customerList()
