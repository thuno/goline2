...
$('body > #body').load('https://cdn.jsdelivr.net/gh/thuno/goline2@f71ad52/project-component/loading.html', async function () {
    ...
    $('body > #body').load('https://cdn.jsdelivr.net/gh/thuno/goline2@f71ad52/screen/module/file/local-component/body-layout.html', async function () {
        permissionTool()
        customerList()
