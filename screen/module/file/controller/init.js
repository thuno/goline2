...
$('body > #body').load('https://cdn.jsdelivr.net/gh/thuno/goline2@803bc8c/project-component/loading.html', async function () {
    ...
    if (pInforRes.Code === 200) {
        ...
        $('body > #body').load('https://cdn.jsdelivr.net/gh/thuno/goline2@803bc8c/screen/module/file/local-component/body-layout.html', async function () {
            permissionTool()
            customerList()
