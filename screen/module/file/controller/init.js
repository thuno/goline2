...
$('body > #body').load('https://cdn.jsdelivr.net/gh/thuno/goline2@32b7af2/project-component/loading.html', async function () {
    // customerList()
    ...
    $('body > #body').load('https://cdn.jsdelivr.net/gh/thuno/goline2@32b7af2/screen/module/file/local-component/body-layout.html', function () {
        permissionTool()
