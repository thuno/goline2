...
$('body > #body').load('https://cdn.jsdelivr.net/gh/thuno/goline2@d8e99a0/project-component/loading.html', async function () {
    ...
    $('body > #body').load('https://cdn.jsdelivr.net/gh/thuno/goline2@d8e99a0/screen/module/file/local-component/body-layout.html', async function () {
        permissionTool()
        customerList()
