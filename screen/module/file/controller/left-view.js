    ...
    searchBody.replaceChildren(
      ...filterList.reverse().map(wb => {
        ...
        if (wb.IsWini && !wb.value.classList.contains('w-variant')) {
          cateImg.src = 'https://cdn.jsdelivr.net/gh/WiniGit/goline@0a15f5d/lib/assets/component.svg'
        } else if (wb.value.classList.contains('w-container')) {
          cateImg.src = 'https://cdn.jsdelivr.net/gh/WiniGit/goline@0a15f5d/lib/assets/frame_black.svg'
        } else if (wb.value.classList.contains('w-rect')) {
          cateImg.src = 'https://cdn.jsdelivr.net/gh/WiniGit/goline@0a15f5d/lib/assets/rectangle_black.svg'
        } else if (wb.value.classList.contains('w-text')) {
          cateImg.src = 'https://cdn.jsdelivr.net/gh/WiniGit/goline@0a15f5d/lib/assets/text_black.svg'
        } else if (wb.value.classList.contains('w-variant')) {
          cateImg.src = 'https://cdn.jsdelivr.net/gh/WiniGit/goline@0a15f5d/lib/assets/multiple_component.svg'
        } else {
          cateImg.src = 'https://cdn.jsdelivr.net/gh/WiniGit/goline@0a15f5d/lib/assets/base_component_black.svg'
        }
...
function createLayerTile(wb, isShowChildren = false) {
  ...
  <input class="semibold1" readonly value="${wb.Name}"/>
  <i class="fa-solid fa-lock is-lock"></i>`
