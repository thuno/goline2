$('body > #home-body').load('https://cdn.jsdelivr.net/gh/thuno/goline2@latest/project-component/loading.html', async function () {
    ...
    $('body > #home-body').load('https://cdn.jsdelivr.net/gh/thuno/goline2@latest/screen/module/home/local-component/body-layout.html', function () {
