$('body > #home-body').load('https://cdn.jsdelivr.net/gh/thuno/goline2@a422493/project-component/loading.html', async function () {
    ...
    await TeamDA.init()
    const x = new Date()
    $('body > #home-body').load('https://cdn.jsdelivr.net/gh/thuno/goline2@a422493/screen/module/home/local-component/body-layout.html', function () {
