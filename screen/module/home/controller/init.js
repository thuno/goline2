$('body > #home-body').load('https://cdn.jsdelivr.net/gh/thuno/goline2@3acda94/project-component/loading.html', async function () {
    ...
    await TeamDA.init()
    const x = new Date()
    $('body > #home-body').load('https://cdn.jsdelivr.net/gh/thuno/goline2@3acda94/screen/module/home/local-component/body-layout.html', function () {
