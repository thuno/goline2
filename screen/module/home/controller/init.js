$('body > #home-body').load('https://cdn.jsdelivr.net/gh/thuno/goline2@9350aab/project-component/loading.html', async function () {
    ...
    await TeamDA.init()
    const x = new Date()
    $('body > #home-body').load('https://cdn.jsdelivr.net/gh/thuno/goline2@9350aab/screen/module/home/local-component/body-layout.html', function () {
