$('body > #home-body').load('https://cdn.jsdelivr.net/gh/thuno/goline2@fa9a2a6/project-component/loading.html', async function () {
    ...
    $('body > #home-body').load('https://cdn.jsdelivr.net/gh/thuno/goline2@fa9a2a6/screen/module/home/local-component/body-layout.html', function () {
