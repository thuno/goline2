$('body > #home-body').load('https://cdn.jsdelivr.net/gh/thuno/goline2@adefc9b/project-component/loading.html', async function () {
    ...
    $('body > #home-body').load('https://cdn.jsdelivr.net/gh/thuno/goline2@adefc9b/screen/module/home/local-component/body-layout.html', function () {
