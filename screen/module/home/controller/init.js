$('body > #home-body').load('https://cdn.jsdelivr.net/gh/thuno/goline2@692f680/project-component/loading.html', async function () {
    ...
    await TeamDA.init()
    const x = new Date()
    $('body > #home-body').load('https://cdn.jsdelivr.net/gh/thuno/goline2@692f680/screen/module/home/local-component/body-layout.html', function () {
