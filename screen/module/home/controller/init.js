$('body > #home-body').load('https://cdn.jsdelivr.net/gh/thuno/goline2@cee661d/project-component/loading.html', async function () {
    ...
    await TeamDA.init()
    const x = new Date()
    $('body > #home-body').load('https://cdn.jsdelivr.net/gh/thuno/goline2@cee661d/screen/module/home/local-component/body-layout.html', function () {
