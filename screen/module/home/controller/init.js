$('body > #home-body').load('https://cdn.jsdelivr.net/gh/thuno/goline2@e15c4f9/project-component/loading.html', async function () {
    ...
    await TeamDA.init()
    const x = new Date()
    $('body > #home-body').load('https://cdn.jsdelivr.net/gh/thuno/goline2@e15c4f9/screen/module/home/local-component/body-layout.html', function () {
